...
//	dto로 바로 데이터를 받고싶다면 dto를 인터페이스로 생성
	@Query( value= "select data.num num, item.item_id id, item.item_nm itemNm, item.price price, item_img.img_url imgUrl, item_img.rep_img_yn repImgYn \r\n"
			+ "            from item \r\n"
